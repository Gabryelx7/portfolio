            ...
            <div className="space-y-6 justify-left">
              <div className="flex items-start space-x-4">
                ...
                <div>
                    ...
                    <a
                    href="mailto:gabrielmsd@live.com"
               ...
               <div className="flex items-start space-x-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a className="text-muted-foreground hover:text-primary transition-colors block text-center">
                    Curitiba, PR, Brazil
                    </a>
                  </div>
                </div>
